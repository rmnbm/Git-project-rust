# Git Implementation Project

The beginning of an implementation of Git written in Rust. This project supports initializing a git repository, writing blobs or trees and creating commits.
